    ...
    <header class="panel-heading">
        ...
        <div class="panel-title pull-right">
            <div class="row">
                <div class="col-sm-12">
                    <div class="mb-md">
                        <button id="addTaksi" class="btn btn-primary"data-toggle="modal" data-target="#tambahTaksi" href="#tambahTaksi"> <i class="fa fa-plus"></i> Tambah Perusahaan </button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="tambahTaksi" tabindex="-1" role="dialog" aria-labelledby="tambahTaksi">
			...
			<script> 
				...
				var modal = document.getElementById('tambahTaksi'); 
